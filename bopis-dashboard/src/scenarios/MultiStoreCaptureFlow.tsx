  ...
  purchase_units: [
    {
      ...
      amount: { currency_code: 'USD', value: '899.00', breakdown: { item_total: { currency_code: 'USD', value: '899.00' } } },
      items: [{ name: 'LG French Door Refrigerator', description: 'LG 26 cu. ft. French Door Refrigerator with InstaView.', unit_amount: { currency_code: 'USD', value: '899.00' }, quantity: '1', category: 'PHYSICAL_GOODS' }],
      shipping: { type: 'PICKUP_IN_STORE', name: { full_name: 'Best Buy San Jose' }, address: { address_line_1: '1600 Saratoga Ave', admin_area_2: 'San Jose', admin_area_1: 'CA', postal_code: '95129', country_code: 'US' } },
    },
    {
      reference_id: 'store-b',
      description: 'Samsung 前置滚筒洗衣机 (Samsung Front Load Washer) @ Best Buy Los Angeles',
      amount: { currency_code: 'USD', value: '649.00', breakdown: { item_total: { currency_code: 'USD', value: '649.00' } } },
      items: [{ name: 'Samsung Front Load Washer', description: 'Samsung 4.5 cu. ft. High-Efficiency Front Load Washer.', unit_amount: { currency_code: 'USD', value: '649.00' }, quantity: '1', category: 'PHYSICAL_GOODS' }],
      shipping: { type: 'PICKUP_IN_STORE', name: { full_name: 'Best Buy Los Angeles' }, address: { address_line_1: '1015 Wilshire Blvd', admin_area_2: 'Los Angeles', admin_area_1: 'CA', postal_code: '90017', country_code: 'US' } },
    },
    {
      reference_id: 'store-c',
      description: 'Samsung 烘干机 (Samsung Electric Dryer) @ Best Buy Seattle',
      amount: { currency_code: 'USD', value: '599.00', breakdown: { item_total: { currency_code: 'USD', value: '599.00' } } },
      items: [{ name: 'Samsung Electric Dryer', description: 'Samsung 7.5 cu. ft. Electric Dryer with Steam Sanitize+.', unit_amount: { currency_code: 'USD', value: '599.00' }, quantity: '1', category: 'PHYSICAL_GOODS' }],
      shipping: { type: 'PICKUP_IN_STORE', name: { full_name: 'Best Buy Seattle' }, address: { address_line_1: '400 Pine St', admin_area_2: 'Seattle', admin_area_1: 'WA', postal_code: '98101', country_code: 'US' } },
    },
    {
      reference_id: 'store-d',
      description: 'Bissell CrossWave 洗地机 @ Best Buy Chicago',
      amount: { currency_code: 'USD', value: '349.00', breakdown: { item_total: { currency_code: 'USD', value: '349.00' } } },
      items: [{ name: 'Bissell CrossWave Floor Cleaner', description: 'Bissell CrossWave All-In-One Multi-Surface Wet Dry Vacuum.', unit_amount: { currency_code: 'USD', value: '349.00' }, quantity: '1', category: 'PHYSICAL_GOODS' }],
      shipping: { type: 'PICKUP_IN_STORE', name: { full_name: 'Best Buy Chicago' }, address: { address_line_1: '900 N Michigan Ave', admin_area_2: 'Chicago', admin_area_1: 'IL', postal_code: '60611', country_code: 'US' } },
    },
    {
      reference_id: 'store-e',
      description: 'Midea 窗式空调 (Midea Window Air Conditioner) @ Best Buy New York',
      amount: { currency_code: 'USD', value: '449.00', breakdown: { item_total: { currency_code: 'USD', value: '449.00' } } },
      items: [{ name: 'Midea Window Air Conditioner', description: 'Midea 8,000 BTU Window Air Conditioner with Inverter.', unit_amount: { currency_code: 'USD', value: '449.00' }, quantity: '1', category: 'PHYSICAL_GOODS' }],
      shipping: { type: 'PICKUP_IN_STORE', name: { full_name: 'Best Buy New York' }, address: { address_line_1: '529 5th Ave', admin_area_2: 'New York', admin_area_1: 'NY', postal_code: '10017', country_code: 'US' } },
    },
  ],
  payment_source: {
    paypal: {
